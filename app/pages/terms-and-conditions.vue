...
// ============================================================
// صفحة الشروط والأحكام - Terms & Conditions (SEO Optimized)
...
const fallbackPage: PageData = {
  ...
  meta_title: 'الشروط والأحكام - عن مصر',
  meta_description: 'اطلع على الشروط والأحكام الخاصة باستخدام موقع عن مصر.',
  meta_keywords: 'الشروط والأحكام, عن مصر, سياسة الاستخدام',
  content: `مرحبًا بكم في موقع **عن مصر**. باستخدامك لهذا الموقع، فإنك توافق على الالتزام بالشروط والأحكام التالية.`,
  sections: {},
...
// ✅ SSR عبر useAsyncData
const { data: pageData } = await useAsyncData('terms-page', async () => {
  try {
    const data = await fetchWithRetry<PageData>(`${API_BASE}/api/pages/terms-and-conditions/`)
...
useHead(() => {
  ...
  const title       = p?.meta_title || p?.title || 'الشروط والأحكام - عن مصر'
  const description = p?.meta_description || 'اطلع على الشروط والأحكام الخاصة باستخدام موقع عن مصر.'
      ...
      // BreadcrumbList
      {
        ...
        innerHTML: JSON.stringify({
          ...
          itemListElement: [
            ...
            { '@type': 'ListItem', position: 2, name: p?.title || 'الشروط والأحكام', item: canonicalUrl },
          ],
        }),
      },
    ],
